...
public class CountryStatsController {
    ...
    @GetMapping(value = "/countries-stats/{countryCode}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/countries-stats", produces = MediaType.APPLICATION_JSON_VALUE)
